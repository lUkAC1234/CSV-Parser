...
class SVG_WifiError extends PureComponent<{
    id?: string;
}> {
    render(): ReactNode {
        return (
            <svg id={this.props.id} width="48" height="48" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                <g fill="#fff">
                    <g>
